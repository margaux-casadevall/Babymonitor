 ...
 * Generated at: 2023-01-16 03:17:17 UTC
...
public final class data_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    User user = (User)request.getSession().getAttribute("user");
      ...
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <canvas id=\"myGraph\" style=\"width: 25%; height: auto;\">\n");
      out.write("        <script>\n");
      ...
      out.write("\n");
      out.write("            const dataCopy = glucoseLevels.map(item => {\n");
      out.write("                const date = new Date(item.timestamp);\n");
      out.write("                const totalMinutes = date.getHours() * 60 + date.getMinutes();\n");
      out.write("                return {...item, totalMinutes};\n");
      out.write("            });\n");
      out.write("            console.log(dataCopy);\n");
      out.write("            const sortedData = dataCopy.sort((a, b) => new Date(a.timestamp) - new Date(b.timestamp));\n");
      out.write("\n");
      out.write("            const dataCopyHP = glucoseLevelsHP.map(item => {\n");
      out.write("                const date = new Date(item.timestamp);\n");
      out.write("                const totalMinutesHP = date.getHours() * 60 + date.getMinutes();\n");
      out.write("                return {...item, totalMinutesHP};\n");
      out.write("            });\n");
      out.write("            console.log(dataCopyHP);\n");
      out.write("            const sortedDataHP = dataCopyHP.sort((a, b) => new Date(a.timestamp) - new Date(b.timestamp));\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("                    datasets: [\n");
      out.write("                        {\n");
      out.write("                            data: sortedData.map(item => ({x: item.timestamp, y: item.value})),\n");
      ...
      out.write("                            fill: false\n");
      out.write("                        }, {\n");
      out.write("                            data: sortedDataHP.map(item => ({x: item.timestamp, y: item.value})),\n");
      ...
      out.write("                            yAxisID: 'B',\n");
      out.write("                            label: 'Patch threshold',\n");
      out.write("                            pointRadius: 0,\n");
